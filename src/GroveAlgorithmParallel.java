...
/**
* This code is a modified version of the code from GroveAlgorithmSequential.java which was generated by chat gpt
 * The modification made for parallelisation are reproduction from the exemple of "synchronisation using lock" given by  Mohammed Shehab for the course CEWP MOD1 of Concordia
*
* */
public class GroveAlgorithmParallel {
    public static int n;
    ...
    public static void main(String[] args) {
        ...
        n = 128; // You can change this to your desired size
        ...
        System.out.println("Solution found at index " + maxIndex + " with multiple thread.");
    }
